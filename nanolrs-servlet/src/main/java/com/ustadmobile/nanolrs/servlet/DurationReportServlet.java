...
public class DurationReportServlet extends HttpServlet {

    public DurationReportServlet() {
        super();
        System.out.println("In DurationReportServlet()..");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("In DurationReportServlet.doGet()..");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("In DurationReportServlet.doPost()..");
