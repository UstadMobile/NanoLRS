...
public class DiversityReportServlet extends HttpServlet {

    public DiversityReportServlet() {
        super();
        System.out.println("In DiversityReportServlet()..");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("In DiversityReportServlet.doGet()..");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("In DiversityReportServlet.doPOST()..");
